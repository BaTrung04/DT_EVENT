...
export default function Projects() {
  ...
  const projects = [
    {
      titleKey: "Kiểm toán nhà nước",
      descriptionKey: "Kiểm toán nhà nước đại hội VIII",
      categoryKey: "Triển lãm",
      image: "/images/kiem-toan-nha-nuoc.jpg",
      date: "24/06/2025",
    },
    {
      titleKey: "Hội thảo VNPT",
      descriptionKey: "Đổi mới sáng tạo VNPT",
      categoryKey: "Sự kiện",
      image: "/images/su-kien-vnpt.jpg",
      date: "08/05/2025",
    },
    {
      titleKey: "VNPT Kinh tế đô thị",
      descriptionKey: "Mở khóa AI, dẫn nhịp thời sự số",
      categoryKey: "Quảng bá",
      image: "/images/vnpt-kinh-te-do-thi.jpg",
      date: "16/05/2025",
    },
    {
      titleKey: "Du lịch Quảng Ninh đoàn VNPT",
      descriptionKey: "Du lịch Quảng Ninh đoàn VNPT",
      categoryKey: "Du lịch",
      image: "/images/du-lich-quang-ninh.png",
      date: "08/07/2025",
    },
    {
      titleKey: "VNPT FAMILY RUN 2025",
      descriptionKey: "Giải chạy VNPT",
      categoryKey: "Giải chạy",
      image: "/images/vnpt-family-run.png",
      date: "21/06/2025",
    },
    {
      titleKey: "Du lịch Quy Nhơn",
      descriptionKey: "Du lịch Quy Nhơn",
      categoryKey: "Du lịch",
